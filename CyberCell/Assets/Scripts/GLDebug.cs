...
");
	...
	public static void DrawArrow (Vector3 start, Vector3 dir, float arrowHeadLength = 0.25f, float arrowHeadAngle = 20, Color? color = null, float duration = 0, bool depthTest = false)
	{
		...
		Vector3 right = Quaternion.LookRotation (dir) * Quaternion.Euler (0, 0, 180 + arrowHeadAngle) * Vector3.forward;
		Vector3 left  = Quaternion.LookRotation (dir) * Quaternion.Euler (0, 0, 180 - arrowHeadAngle) * Vector3.forward;
